...
function Update() { 
  ...
  function getSingleData() {
    ...
    axios.get("http://localhost:9090/getByRollno/"+id)
    .then((res)=> {
  ...
  function onUpdate(data) {
    alert("Form updated...!!");
    console.log(data);
    // axios.put('http://localhost:3000/students/'+data.id,data)
    axios.put('http://localhost:9090/update/'+data.id,data)
    .catch((error)=> console.log(error))
    navigate("/login");
  }
  ...
  <div className="row justify-content-center">
    <div className="col-md-10">
      ...
      <h4 className="text-center mb-3">Update Details</h4>

      <form onSubmit={handleSubmit(onUpdate)} className="border p-3 rounded shadow-sm">
